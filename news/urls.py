...
urlpatterns = [
    ...
    path('edit_news_item/<int:news_item_id>/', views.edit_news_item, name='edit_news_item'),
    path('delete_news_item/<int:news_item_id>/', views.delete_news_item, name='delete_news_item'),
]
